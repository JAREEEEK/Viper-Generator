...
When you decide to use VIPER architecture in your project, it is very tired create new modules, because you need create at least 5 files for each. Imagine that you need to create 6 modules... Based on [this](https://github.com/Juanpe/Swift-VIPER-Module) template with little improvements.
